...
// */
//#ifndef __CEL_CRYPTO_MPI_H__
//#define __CEL_CRYPTO_MPI_H__
//
//#include "cel/types.h"
//
...
// */
//int mpi_set_bit( mpi *X, size_t pos, BYTE val );
//
///**
...
// *                 POLARSSL_ERR_MPI_MALLOC_FAILED if memory allocation failed
// */
//int mpi_read_binary( mpi *X, const BYTE *buf, size_t buflen );
//
///**
...
// */
//int mpi_write_binary( const mpi *X, BYTE *buf, size_t buflen );
//
///**
...
// *                 be set to NULL if the extra perf is unneeded.
// */
